...
general_training() {
  ...
  echo "  the experiment by following step 8's instructions on the experiment website:"
...
tellina_training() {
  ...
  echo "  Try to decompose what you want to achieve in smaller tasks and sentences."
  echo ""
  read -n 1 -s -r -p "Press any key to continue..."
  echo ""
  echo ""
