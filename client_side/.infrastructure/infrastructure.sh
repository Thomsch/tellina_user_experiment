...
general_training() {
  ...
  echo ""
  echo "- If this experiment terminal crashes or is exited by accident, please"
  echo "  restart the experiment by typing 'source experiment/configure' in"
  echo "  a new Bash terminal. Your session will resume on your current task."
  echo ""
  read -n 1 -s -r -p "Press any key to continue..."
  echo ""
  echo ""
...
tellina_training() {
  ...
  echo "Tellina does not always give you a perfect answer, however."
  echo ""
  read -n 1 -s -r -p "Press any key to continue..."
  echo ""
  echo ""
  ...
  echo "  -> Tellina gives you a list of Bash one-liners it thinks are the"
  echo "     most relevant."
  echo ""
